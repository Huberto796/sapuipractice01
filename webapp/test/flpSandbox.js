			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testuno-display": {
								"semanticObject": "testuno",
								"action": "display",
								"description": "Ejemplo de aplicacion de business application studio",
								"title": "testuno",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=spinner.ayotlo.com.project1",
									"url": sap.ui.require.toUrl("spinner/ayotlo/com/project1")
								}
							}
						}
					}
